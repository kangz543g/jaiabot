...
function TaskOptionsPanel(props: Props) {
    ...
    function selectOnMapClicked() {
        ...
        draw.on("drawend", (evt) => {
            ...
            let rhumbBearing = fmod(
                turf.rhumbBearing([start.lon, start.lat], [end.lon, end.lat]),
                360,
            );
            constant_heading.constant_heading = Number(rhumbBearing.toFixed(0));

            let rhumbDistance = turf.rhumbDistance([start.lon, start.lat], [end.lon, end.lat], {
                units: "meters",
            });
    ...
    switch (task.type) {
                ...
                <div id="DriftDiv">
                    <table className="TaskParametersTable">
                        <tbody>
                            <tr className="task-param-container">
                                <td className="task-label">Drift Time</td>
                                <td className="input-row drift-time">
                                    <input
                                        type="number"
                                        step="1"
                                        className="NumberInput"
        ...
        case TaskType.CONSTANT_HEADING:
            ...
            const selectOnMapButton =
                props.location != null ? (
                    <button
                        className={"select-on-map" + clickingMapClass}
                    ...
                    <table className="TaskParametersTable">
                        <tbody>
                            ...
                            <tr className="task-param-container">
                                ...
                                <td className="input-row constant-heading-time">
                                    <input
                                        type="number"
                                        step="1"
                                        className="NumberInput"
                            ...
                            <tr className="task-param-container">
                                ...
                                <td className="input-row constant-heading-speed">
                                    <input
                                        type="number"
                                        min="1"
                                        max="3"
                            ...
                            <tr className="task-param-container">
                                ...
                                <td className="input-row constant-heading-distance">
                                    <span>
                                        {calculateDistance(
